...
namespace TEAM3FINAL
{
    public partial class FrmCompanyEndByMonth2 : TEAM3FINAL.baseForm2, CommonBtn
    {
        ...
        private void DataGridViewColumnSet()
        {
            ...
            //일반컬럼 추가
            DataGridViewUtil.AddNewColumnToDataGridView(dgvCom, "업체코드", "COM_CODE", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvCom, "업체명", "ITEM_COM_DLVR", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvCom, "사업자번호", "COM_REG_NUM", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvCom, "금액", "TTLPRICE", true, 80);
            ...
            //데이터그리드뷰 체크박스 컬럼 추가
            //일반컬럼 추가
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "업체명", "ITEM_COM_DLVR", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "납품업체명", "ITEM_COM_REORDER", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "입고일", "INS_DATE", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "카테고리", "INS_TYP", true, 80);
            ...
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "수불량", "INS_QTY", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "단가", "MC_UNITPRICE_CUR", true, 80);
            DataGridViewUtil.AddNewColumnToDataGridView(dgvComDetail, "금액", "TTLPRICE", true, 80);
